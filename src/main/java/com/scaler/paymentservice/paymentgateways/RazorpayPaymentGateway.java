...
@Service //needs to be service in order to autowire
public class RazorpayPaymentGateway implements PaymentGatewayInterface{

    @Autowired
    private RazorpayClient razorpayClient;
//
//    Constructor injection is giving razorpayClient as null -> NPE
...
//        paymentLinkRequest.put("description","Payment for policy no #23456");
        ...
        customer.put("name", userPhone);//it is built in this way-> if u change phone to name it throws NPE
